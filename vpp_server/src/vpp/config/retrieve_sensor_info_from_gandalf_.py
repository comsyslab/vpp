...
''' This is a quick'n'dirty script to import sensor info from the gandalf server on the Dept. of Engineering network /ubbe '''
...
def get_connection():
    return psycopg2.connect("dbname='RollingDbProduction' host='' user='' password=''")
