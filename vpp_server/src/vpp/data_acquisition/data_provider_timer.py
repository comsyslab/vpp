...
class DataProviderTimer(object):
    ...
    def __init__(self, data_processor):
        ...
        self.fetch_interval = data_processor.get_interval()
        self.stop_signal = threading.Event()
        self.thread = None
        self.last_fetch = 0

    def start(self):
        name = __name__ + " " + str(self.data_processor.get_id())
        self.stop()
        self.stop_signal = threading.Event()
    ...
    def _run(self):
        ...
        self.logger.debug("DataProvider %d exiting due to stop signal", self.data_processor.get_id())

    def stop(self):
        self.logger.info("DataProvider %d received stop signal", self.data_processor.get_id())
